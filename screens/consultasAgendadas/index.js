        ...
        <View style={styles.container2}>
          <View style={styles.cardConsulta}>
            ...
            <View style={styles.infoContainer}>
              ...
              <Text style={styles.descricao}>Avaliação geral de saúde e acompanhamento de rotina</Text>
              <View style={styles.dataHoraContainer}>
                <Text style={styles.data}>15/04/2024</Text>
          ...
          <View style={styles.cardConsulta}>
            ...
            <View style={styles.infoContainer}>
              ...
              <Text style={styles.descricao}>Coleta de sangue para exames laboratoriais</Text>
              <View style={styles.dataHoraContainer}>
                <Text style={styles.data}>20/04/2024</Text>
          ...
          <View style={styles.cardConsulta}>
            ...
            <View style={styles.infoContainer}>
              ...
              <Text style={styles.descricao}>Avaliação cardíaca completa com eletrocardiograma</Text>
              <View style={styles.dataHoraContainer}>
                <Text style={styles.data}>25/04/2024</Text>
